...
function FetchAPIFormulario() {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.nickName.trim()) newErrors.nickName = "Apelido é obrigatório";
  ...
  return (
    <>
      <h1>Mandar o formulario para API</h1>
...
export default FetchAPIFormulario;
